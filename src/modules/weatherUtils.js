...
function getWeatherConditionUsingCode(code) {
	const newIcons = {
		Clear: [1000, 1, 0],
		Rain: [
			1063, 1069, 1180, 1183, 1186, 1189, 1192, 1195, 1198, 1201, 1237,
			1240, 1243, 1246, 1249, 1252, 1261, 1264, 61, 63, 65, 80, 81, 82,
		],
		Storm: [1087, 1273, 1276, 1279, 1282, 66, 67, 95, 96, 99],
		Cloudy: [
			1006, 1009, 1030, 1072, 1117, 1135, 1147, 1150, 1153, 1168, 1171,
			1204, 1207, 45, 48, 51, 53, 55, 56, 57,
		],
		"Few Clouds": [1003, 2, 3],
		Snow: [
			1066, 1114, 1210, 1213, 1216, 1219, 1222, 1225, 1255, 1258, 71, 73,
			75, 77, 85, 86,
		],
	}
